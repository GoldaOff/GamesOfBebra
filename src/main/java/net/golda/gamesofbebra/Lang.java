...
public enum Lang
{
    ...
    GAME_PLAYER_JOIN_CANCELED("game-player-join-cancaled", "&6Вы не можете присоединиться к игре"),
    ...
    GAME_END_CANCELED_NOT_OWNER("game-end-cancaled-not-owner", "&6Вы не можете закончить эту игру"),
